...
"""
def minutes_to_hours_and_minutes():    #this names the function
    ...
    print("That is equivalent to", hours, "hours and", minutes, "minutes") #this prints the answer that the user will see

minutes_to_hours_and_minutes()    #this calls the function so that it will be executed
